...
def generate_data():
    ...
    Downsampler12 = Downsampler(4, padding=4, sig=1)
...
def crop_data(hs_data, pan_data, label_data):
    train_ratio = 0.8
    train_factor = 1
    ...
    # hs_data = np.float32(np.load('/home/aistudio/work/wuhan_wv2/ms_8m.npy'))
    # pan_data = np.float32(np.load('/home/aistudio/work/wuhan_wv2/pan_2m.npy'))
    # label_data = np.float32(np.load('/home/aistudio/work/wuhan_wv2/ms_2m.npy'))

    # hs_test = np.float32(np.load('/home/aistudio/work/wuhan_wv2/ms_2m.npy'))
    # pan_test = np.float32(np.load('/home/aistudio/work/wuhan_wv2/pan_05m.npy'))
